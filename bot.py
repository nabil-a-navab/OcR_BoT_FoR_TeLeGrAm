...
def contact(update,context):
    ...
    update.message.reply_text("Hey! You can find me on \n[Telegram](https://telegram.me/nabilanavab)", parse_mode=telegram.ParseMode.MARKDOWN)
    update.message.reply_text("Join channel : @nabil_a_navab \nIf you have any questions ask me : @nabilanavab")
...
def donate(update,context):
    update.message.reply_text("You can support me by joining my channel",parse_mode=ParseMode.MARKDOWN)
    return donate
